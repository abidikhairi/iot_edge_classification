...
def main(args):
    experiment = wandb.init(project='edge-classifcation', entity='u-jendouba-ai', name='GCN IOT Edge Classification')
    ...
    model = GCN(node_feature_size=node_feature_size, edge_feature_size=edge_feature_size, num_classes=num_classes)
    ...
    with torch.no_grad():
        ...
        disp.plot()
        plt.savefig('images/confusion_matrix_gcn.png')
